            ...
            <Wrapper>
                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <Service
                            ...
                            desc="Familiarity with popular front-end frameworks like React, as well as knowledge of libraries(Next.js) and tools that complement these frameworks."
                            data={[
                                "Javascript",
                                "React",
                                "Next.js",
                        ...
                        <Service
                            num="2"
                            title="Ui/Ux Design"
                            desc="Highly motivated and creative UI/UX designer with a passion for creating intuitive and visually appealing user experiences. Seeking an opportunity to contribute my skills and knowledge to a dynamic team and grow as a professional in the field of UI/UX design."
                            data={[
                                "Responsive Design:",
                                "Design Tools",
                                "User Experience",
                        ...
                        <Service
                            ...
                            desc="The tech industry evolves rapidly, so a willingness to learn and keep up with the latest front-end development trends and best practices is essential for staying relevant (That why I learn and enroll in the web 3.O,blockchain and AI program duration 1.5 years )"
                            data={[
                                "Web 3.O",
                                "Blockchain",
                                "Metaverse ",
                        ...
                        <Service
                            ...
                            desc="Good communication skills are essential for collaborating with team members, understanding project requirements, and translating design concepts into functional code"
                            data={[
                                "listening",
