    ...
    return (
        ...
        >
            ...
            <Wrapper>
                {/* NAVBAR START */}
                <motion.div
                    className="hidden md:flex items-center justify-between mt-[40px] 2xl:mt-[53px] relative"
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>abdullahgamer980@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Mohummad Abdullah</span>
                    </div>
